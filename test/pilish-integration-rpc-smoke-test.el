;;; pilish-integration-rpc-smoke-test.el --- Cheap RPC smoke tests -*- lexical-binding: t; -*-
...
(pilish-integration-deftest
  ...
  (let ((response (pilish--rpc-sync proc '(:type "get_state") 10)))
    (should response)
...
(pilish-integration-deftest
  ...
  (let ((response (pilish-integration--rpc-until
...
(pilish-integration-deftest
  ...
  (let* ((response (pilish--rpc-sync proc '(:type "get_fork_messages")
                                              pilish-test-rpc-timeout))
...
(provide 'pilish-integration-rpc-smoke-test)
;;; pilish-integration-rpc-smoke-test.el ends here
