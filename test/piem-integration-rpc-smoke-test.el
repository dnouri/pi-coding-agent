;;; piem-integration-rpc-smoke-test.el --- Cheap RPC smoke tests -*- lexical-binding: t; -*-
...
(piem-integration-deftest
  ...
  (let ((response (piem--rpc-sync proc '(:type "get_state") 10)))
    (should response)
...
(piem-integration-deftest
  ...
  (let ((response (piem-integration--rpc-until
...
(piem-integration-deftest
  ...
  (let* ((response (piem--rpc-sync proc '(:type "get_fork_messages")
                                              piem-test-rpc-timeout))
...
(provide 'piem-integration-rpc-smoke-test)
;;; piem-integration-rpc-smoke-test.el ends here
