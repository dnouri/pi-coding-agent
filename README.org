...
- Semantic activity phases in header line (thinking/replying/running/compact)
- Header context group with optional session name
- Extension header status and transient working messages (setWorkingMessage,
  when emitted by the connected pi CLI)
