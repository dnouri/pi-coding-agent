...
#+html: <video src="https://danielnouri.org/media/pi-coding-agent-demo.mp4" width="100%" controls></video>
...
buffers with =C-y=, or use any editing commands you know. If you prefer
Vim-style editing, [[https://github.com/emacs-evil/evil][Evil mode]] works seamlessly—compose
prompts with =i=, =a=, =ciw=, and all the motions you're used to.
